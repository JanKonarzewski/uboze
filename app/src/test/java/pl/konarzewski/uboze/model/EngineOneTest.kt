...
class EngineOneTest {
    ...
    fun getPathsToRepeat() {
        val input = listOf(
            Image("test_path_01", 0, DateTime("2022-01-01T01:01:01.000"), null),
            Image("test_path_02", 1, DateTime("2022-01-01T01:01:01.000"), null),
            Image("test_path_03", 2, DateTime("2022-01-01T01:01:01.000"), null),
            Image("test_path_04", 3, DateTime("2022-01-01T01:01:01.000"), null)
        )
